...
class AddCategory extends React.Component {
    ...
    <div >
    <form onSubmit={this.AddSign}>
            <div className="form-group ">
                
            <label >Sign Name</label>

            <input type="text" className="form-control" id="name" placeholder="Sign name" name="categoryname" value={this.state.categoryname} onChange={this.handleChange}  required/>
        </div>
        <div className="form-group ">
        ...
        <CustomInput type='file' id='profilePic'
         ...
         <button type="submit"  className="btn btn-success">Add Sign</button>
         </form>
            </div>
